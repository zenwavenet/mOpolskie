...
class AttractionCastleActivity : ComponentActivity() {
    private lateinit var viewModel: AttractionView1Model

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_attraction)
        viewModel = ViewModelProvider(this)[AttractionView1Model::class.java]
        ...
        lifecycleScope.launch {
            ...
            if (success) {
                ...
                Toast.makeText(this@AttractionCastleActivity, "Błąd podczas pobierania danych.", Toast.LENGTH_SHORT).show()
            }
        }
    }
...
interface AttractionApi1Service {
    @GET("/__api/mopolskie/atrakcje/1")
    suspend fun getAttractions(): Response<Map<String, Map<String, Attraction>>>

    companion object {
        private const val BASE_URL = "https://api.goflux.pl"

        fun create(): AttractionApi1Service {
            return Retrofit.Builder()
                .baseUrl(BASE_URL)
                .addConverterFactory(GsonConverterFactory.create())
                .build()
                .create(AttractionApi1Service::class.java)
        }
    }
}
