...
class WywozSmieciCisekKobyliceActivity : ComponentActivity() {
    private lateinit var viewModel: Waste19ViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.waste_cisek_kobylice)
        viewModel = ViewModelProvider(this)[Waste19ViewModel::class.java]
        ...
        lifecycleScope.launch {
            ...
            if (success) {
                ...
                Toast.makeText(this@WywozSmieciCisekKobyliceActivity, "Nie udało się pobrać danych.", Toast.LENGTH_SHORT).show()
            }
        }
    }
...
interface WasteApi19Service {
    @GET("/__api/mopolskie/wywoz/364")
    suspend fun getWasteSchedule(): Response<WasteResponse>

    companion object {
        private const val BASE_URL = "https://api.stackflow.pl"

        fun create(): WasteApi19Service {
            return Retrofit.Builder()
                .baseUrl(BASE_URL)
                .addConverterFactory(GsonConverterFactory.create())
                .build()
                .create(WasteApi19Service::class.java)
        }
    }
}
