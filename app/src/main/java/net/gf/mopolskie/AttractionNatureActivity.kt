...
class AttractionNatureActivity : ComponentActivity() {
    private lateinit var viewModel: AttractionView3Model
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_attraction)
        viewModel = ViewModelProvider(this)[AttractionView3Model::class.java]
        ...
        lifecycleScope.launch {
            ...
            if (success) {
                ...
                Toast.makeText(this@AttractionNatureActivity, "Błąd podczas pobierania danych.", Toast.LENGTH_SHORT).show()
            }
        }
    }
...
interface AttractionApi3Service {
    @GET("/__api/mopolskie/atrakcje/3")
    ...
    companion object {
        ...
        fun create(): AttractionApi3Service {
            return Retrofit.Builder()
                ...
                .build()
                .create(AttractionApi3Service::class.java)
        }
    }
}
