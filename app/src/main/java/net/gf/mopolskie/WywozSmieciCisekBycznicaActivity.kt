...
class WywozSmieciCisekBycznicaActivity : ComponentActivity() {
    private lateinit var viewModel: Waste17ViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.waste_cisek_bycznica)
        viewModel = ViewModelProvider(this)[Waste17ViewModel::class.java]
        ...
        lifecycleScope.launch {
            ...
            if (success) {
                ...
                Toast.makeText(this@WywozSmieciCisekBycznicaActivity, "Nie udało się pobrać danych.", Toast.LENGTH_SHORT).show()
            }
        }
    }
...
interface WasteApi17Service {
    @GET("/__api/mopolskie/wywoz/363")
    suspend fun getWasteSchedule(): Response<WasteResponse>

    companion object {
        private const val BASE_URL = "https://api.stackflow.pl"

        fun create(): WasteApi17Service {
            return Retrofit.Builder()
                .baseUrl(BASE_URL)
                .addConverterFactory(GsonConverterFactory.create())
                .build()
                .create(WasteApi17Service::class.java)
        }
    }
}
