...
class WywozSmieciCisekKobyliceFActivity : ComponentActivity() {
    private lateinit var viewModel: Waste21ViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.waste_cisek_kobylice_f)
        viewModel = ViewModelProvider(this)[Waste21ViewModel::class.java]
        ...
        lifecycleScope.launch {
            ...
            if (success) {
                ...
                Toast.makeText(this@WywozSmieciCisekKobyliceFActivity, "Nie udało się pobrać danych.", Toast.LENGTH_SHORT).show()
            }
        }
    }
...
interface WasteApi21Service {
    @GET("/__api/mopolskie/wywoz/462")
    suspend fun getWasteSchedule(): Response<WasteResponse>

    companion object {
        private const val BASE_URL = "https://api.stackflow.pl"

        fun create(): WasteApi21Service {
            return Retrofit.Builder()
                .baseUrl(BASE_URL)
                .addConverterFactory(GsonConverterFactory.create())
                .build()
                .create(WasteApi21Service::class.java)
        }
    }
}
