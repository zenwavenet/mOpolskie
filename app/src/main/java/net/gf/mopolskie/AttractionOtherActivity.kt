...
class AttractionOtherActivity : ComponentActivity() {
    private lateinit var viewModel: AttractionView4Model

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_attraction)
        viewModel = ViewModelProvider(this)[AttractionView4Model::class.java]
        ...
        lifecycleScope.launch {
            ...
            if (success) {
                ...
                Toast.makeText(this@AttractionOtherActivity, "Błąd podczas pobierania danych.", Toast.LENGTH_SHORT).show()
            }
        }
    }
...
interface AttractionApi4Service {
    @GET("/__api/mopolskie/atrakcje/4")
    suspend fun getAttractions(): Response<Map<String, Map<String, Attraction>>>

    companion object {
        private const val BASE_URL = "https://api.goflux.pl"

        fun create(): AttractionApi4Service {
            return Retrofit.Builder()
                .baseUrl(BASE_URL)
                .addConverterFactory(GsonConverterFactory.create())
                .build()
                .create(AttractionApi4Service::class.java)
        }
    }
}