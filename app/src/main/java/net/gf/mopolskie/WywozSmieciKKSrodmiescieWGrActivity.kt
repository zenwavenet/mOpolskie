...
class WywozSmieciKKSrodmiescieWGrActivity : ComponentActivity() {
    private lateinit var viewModel: Waste12ViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.waste_kedzierzyn_kozle_srodmiescie_w_gr)
        viewModel = ViewModelProvider(this)[Waste12ViewModel::class.java]
...
interface WasteApi12Service {
    @GET("/__api/mopolskie/wywoz/452")
    ...
    companion object {
        ...
        fun create(): WasteApi12Service {
            return Retrofit.Builder()
                ...
                .build()
                .create(WasteApi12Service::class.java)
        }
    }
}
