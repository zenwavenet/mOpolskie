...
class WywozSmieciCisekBycznicaFActivity : ComponentActivity() {
    private lateinit var viewModel: Waste18ViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.waste_cisek_bycznica_f)
        viewModel = ViewModelProvider(this)[Waste18ViewModel::class.java]
        ...
        lifecycleScope.launch {
            ...
            if (success) {
                ...
                Toast.makeText(this@WywozSmieciCisekBycznicaFActivity, "Nie udało się pobrać danych.", Toast.LENGTH_SHORT).show()
            }
        }
    }
...
interface WasteApi18Service {
    @GET("/__api/mopolskie/wywoz/463")
    suspend fun getWasteSchedule(): Response<WasteResponse>

    companion object {
        private const val BASE_URL = "https://api.stackflow.pl"

        fun create(): WasteApi18Service {
            return Retrofit.Builder()
                .baseUrl(BASE_URL)
                .addConverterFactory(GsonConverterFactory.create())
                .build()
                .create(WasteApi18Service::class.java)
        }
    }
}
