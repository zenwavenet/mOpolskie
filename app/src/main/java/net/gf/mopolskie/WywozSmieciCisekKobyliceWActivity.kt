...
class WywozSmieciCisekKobyliceWActivity : ComponentActivity() {
    private lateinit var viewModel: Waste20ViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.waste_cisek_kobylice_w)
        viewModel = ViewModelProvider(this)[Waste20ViewModel::class.java]
        ...
        lifecycleScope.launch {
            ...
            if (success) {
                ...
                Toast.makeText(this@WywozSmieciCisekKobyliceWActivity, "Nie udało się pobrać danych.", Toast.LENGTH_SHORT).show()
            }
        }
    }
...
interface WasteApi20Service {
    @GET("/__api/mopolskie/wywoz/362")
    suspend fun getWasteSchedule(): Response<WasteResponse>

    companion object {
        private const val BASE_URL = "https://api.stackflow.pl"

        fun create(): WasteApi20Service {
            return Retrofit.Builder()
                .baseUrl(BASE_URL)
                .addConverterFactory(GsonConverterFactory.create())
                .build()
                .create(WasteApi20Service::class.java)
        }
    }
}
